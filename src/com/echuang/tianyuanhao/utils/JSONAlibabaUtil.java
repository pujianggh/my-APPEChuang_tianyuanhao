 ...
 * JSON处理转化
 * 
 * @ClassName: JSONAlibabaUtil
 * @Description: TODO
 * @author 蒲江
 * @date 2016-7-11 上午10:07:38
 */
public class JSONAlibabaUtil {
	 ...
	 * @throws Exception
	 */
	private static StringBuffer assembleJsonConsle(StringBuffer jsonStr,
	 ...
	 * @return
	 */
	private static StringBuffer assembleJsonStr(StringBuffer jsonStr,
			Object key, Object value, int type) {
		if (type == 1)
			return jsonStr.append("\"").append(key).append("\":").append(value)
					.append(",");
		else
			return jsonStr.append("\"").append(key).append("\":\"")
					.append(value).append("\",");
	}
	 ...
	 */
	private static Object invoke(Object obj, Class attrType, String function,
