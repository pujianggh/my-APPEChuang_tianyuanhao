...
public class EarningManagerServiceStateAnotherActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sell_state_another);
		initView();
	}
	...
	public void onClick(View v) {
		...
		case R.id.bt_close_service:
			Toast.makeText(EarningManagerServiceStateAnotherActivity.this, "你点击了立即开通...", Toast.LENGTH_SHORT).show();
			finish();
			break;
