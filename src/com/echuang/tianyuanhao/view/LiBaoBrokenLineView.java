...
public class LiBaoBrokenLineView extends View {
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			if (msg.what == 0x1234) {
				LiBaoBrokenLineView.this.invalidate();
			}
		};
	};

	public LiBaoBrokenLineView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		/*
		 * for (i = 0; i < 8; i++) { netData.add(32+i*5); }
		 */
