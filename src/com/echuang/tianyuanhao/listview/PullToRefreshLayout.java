...
public class PullToRefreshLayout extends RelativeLayout {
	...
	public void setIsNewRefresh(boolean isNew) {
		this.isNewRefresh = isNew;
	}
	...
	public void startRefresh(){
		...
		int height = getResources().getDimensionPixelSize(R.dimen.pull_refresh);
		pullDownY = height;
		refreshView = getChildAt(0);
		initView();
		refreshView.layout(0,0,refreshView.getMeasuredWidth(), (int) (pullDownY));
		refreshingView.startAnimation(refreshingAnimation);
		refreshStateTextView.setText(R.string.refreshing);
//		ObjectAnimator oAnimator = AnimUtils.getObjectAnimator(mRly, 300, null, AnimUtils.getPropertyValuesFloat(AnimUtils.translationY, 0, 0));
//		oAnimator.addUpdateListener(new AnimatorUpdateListener() {
//			
//			@Override
//			public void onAnimationUpdate(ValueAnimator animation) {
//				double time = animation.getCurrentPlayTime();
//				refreshView.layout(0,0,refreshView.getMeasuredWidth(), (int) (pullDownY));
//			}
//		});			
//		oAnimator.start();
...
//			mRly.setLayoutAnimation(Utils.getAnimationController());
		}
...
//			pullView.setVisibility(View.VISIBLE);
			pullView.setVisibility(View.GONE);//修改的隐藏
			break;
	...
	private void initView() {
		// 初始化下拉布局
		mRly = (RelativeLayout)refreshView.findViewById(R.id.lly);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		int emptyHeight = 0;
		if (emptyView != null) {
			emptyView.layout(0, (int) (pullDownY),
					emptyView.getMeasuredWidth(),
					(int) (pullDownY) + emptyView.getMeasuredHeight());
			emptyHeight = emptyView.getMeasuredHeight();
		}
		pullableView.layout(0, (int) (pullDownY) + emptyHeight,
