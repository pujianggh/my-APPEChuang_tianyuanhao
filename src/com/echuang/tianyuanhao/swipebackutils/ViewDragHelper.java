...
package com.echuang.tianyuanhao.swipebackutils;
...
public class ViewDragHelper {
	 ...
	 * callback's
	 * {@link com.ztrong.swipebackutil.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link com.ztrong.swipebackutil.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 * {@link com.ztrong.swipebackutil.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
	 ...
	 * {@link com.ztrong.swipebackutil.ViewDragHelper.Callback#getOrderedChildIndex(int)}
	 * .
	 * 
	 * @param x
	 *            X position to test in the parent's coordinate system
